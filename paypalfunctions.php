<?php
	...
	********************************************/
	...
	//'------------------------------------
	$API_UserName="waynebanks2016-facilitator_api1.gmail.com";
	$API_Password="QVM9562N2B78YKW8";
	$API_Signature="AFcWxV21C7fd0v3bYYYRCpSSRl31A3ofah50hB6ybKi";
	...
	*/
	...
	if ($SandboxFlag == true) 
	{
		...
		$PAYPAL_URL = "https://www.sandbox.paypal.com/webscr?cmd=_express-checkout&TOKEN=EC-5TK89718B4270461K";
		$PAYPAL_DG_URL = "https://www.sandbox.paypal.com/incontext??token=EC-5BT54566231094501";
	}
	else
	{
